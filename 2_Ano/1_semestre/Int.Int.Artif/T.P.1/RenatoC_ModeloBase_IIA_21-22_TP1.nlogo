...
to Go
  MoveComiloes
  MoveLimpadores
  if count turtles = 0 or ticks = 50000
  [
    stop
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="valoresMin_NaoNulos_5c5l" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="sem_limpadores_valMedios" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count comiloes</metric>
    <enumeratedValueSet variable="nLimpadores">
  ...
  <experiment name="semComiloes_valMed" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count limpadores</metric>
    <enumeratedValueSet variable="nLimpadores">
  ...
  <experiment name="Maxalim_menoslixo_Med" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count limpadores</metric>
    <metric>count comiloes</metric>
  ...
  <experiment name="MaxLixo_menosAlim_Med" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count limpadores</metric>
    <metric>count comiloes</metric>
